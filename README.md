...
$$d_{GH^0}(f,g) = \inf \\{ \Delta > 0 : \exists \Delta-isometry \quad i : X \to Y \quad and \quad j : Y \to X \quad such that \quad d_{C^0}(g \circ i, i \circ f) and d_{C^0}(j \circ g, f \circ j) \\}. $$
